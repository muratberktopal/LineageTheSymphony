...
public static class RandomEncounterDatabase
{
    public static List<RandomEventData> GetAllEncounters()
    {
        ...
        Add(e,"bad_water",2,"Nature",0.03f,1200f,false,
            C("IsWinter"),C("ThresholdMet","idle_long",180f),
        ...
        // ── DOĞA OLAYLARI ──────────────────────────────────
        Add(e,"sudden_storm",2,"Nature",0.03f,900f,false,
            C("IsWinter"),C("NeedBelow","coldness",30f),
        ...
        Add(e,"fish_run_spring",1,"Nature",0.12f,600f,false,
            C("HasInvention","FishingRod"),C("IsWinter"),C("NeedBelow","coldness",30f),
        ...
        Add(e,"plague_outbreak",4,"Nature",0.03f,1800f,false,
            C("IsSick"),C("IsWinter"),
        ...
        params object[] items)
    {
        ...
        {
            eventId = id, priority = priority, category = category,
            triggerChance = chance, cooldown = cd, isUnique = unique
        };
